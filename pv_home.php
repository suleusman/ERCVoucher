...
<html lang="en">
<head>
  <title>Payment Voucher Home</title>
  <meta charset="utf-8">
...
<div class="container text-justify" style="max-width:1000px;">    
  <div class="row">
    ...
    <p style="font-size:22px; padding:20px; line-height:2; letter-spacing:5px; color:#000;">Welcome <strong>Staff User Name</strong> to FCT Education Resource Centre (ERC) Accounting Payments Solution Software. This software will make it easy for you to create, store and access all your vouchers.<br>
    Please, enjoy......</p>
