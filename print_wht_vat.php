...
if(empty($inv_no)){
	...
	if(mysqli_num_rows($result) > 0){
			header("location: view_wht_vat.php");
    			} 
...
<h3 >Print Contract WHT and VAT </h3>    
  ...
  <form action="print_wht_vat.php" method="post" target="_new"  style="padding:40px;" >
    <div class="form-group has-feedback">
  <label class=" form-control btn btn-danger" style="font-weight:bold; text-transform:uppercase; background-color:#F62817;">Enter Invoice Number</label>
  			</div>
            
  			 <div class="form-group has-feedback">
  <input type="text"  name="inv_no" placeholder="Invoice Number"  class="form-control" />
